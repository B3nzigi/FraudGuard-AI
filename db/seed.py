...
def seed_data():
    ...
    # Query valid inserted IDs to prevent foreign key constraint violations
    ...
    for i in range(total_transactions):
        ...
        if dice_roll < 0.015:
            ...
            if fraud_type == 'whale':
                ...
                # FIXED: Changed 'second' to 'seconds'
        ...
        # Batch commits to optimize write throughput
        if i % 1000 == 0:
            conn.commit()
    ...
    cur.close()
    conn.close()
    print("Database seeding completed successfully with standard profiles and anomalies!")
